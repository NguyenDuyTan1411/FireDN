...
{
    public class AllSensorsController : Controller
    {
        private readonly ILogger<AllSensorsController> _logger; // Sửa tên logger thành AllSensorsController
        private readonly FireKLContext _context;
        private static bool scanningEnabled = false;
        private static bool savingEnabled = false;
        private const string controllerBaseAddress = "api/all-sensors/"; // Địa chỉ URL cơ sở của controller

        public AllSensorsController(ILogger<AllSensorsController> logger, FireKLContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        [HttpPost]
        [Route(controllerBaseAddress + "data")] // Sửa route thành controllerBaseAddress + "data"
        ...
        [HttpPost]
        [Route(controllerBaseAddress + "control")] // Sửa route thành controllerBaseAddress + "control"
